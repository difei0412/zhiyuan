    ...
    <div style="background-color: white; min-height: 100%;">
     ...
     <div>
      ...
      <div class="aui-card-list">
        ...
        <div class="aui-card-list">
            <div class="aui-card-list-header">
                <div><span class="" style="color:#000"> 打赏：</span></div>
               
            </div>
            <li class="aui-list-item aui-list-item-middle">
             <input type="text" value="5元" style="text-align:center;border-bottom:1px solid #666;color:red">           
           </li>
            
        </div>
         <div class="aui-btn aui-btn-primary aui-btn-block aui-btn-sm" style="background-color: red" @click="next">支付</div>
    </div>
