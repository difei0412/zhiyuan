<template>
	<div style="background-color: white; min-height: 105%;">
    	...
    	<section class="aui-content-padded">
            ...
            <p><div class="aui-label aui-label-danger aui-label-outlined">反馈意见：一天中的大部分时间意志消沉，几乎每天如此，通过两种方式得到证明，一个是主观表达（如感到空虚、无助、悲伤等），另一个是别人的观察（爱哭泣等）。青少年表现为情绪的莫名急躁。</div></p>
		</section>
